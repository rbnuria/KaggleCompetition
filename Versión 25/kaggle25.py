...
Final_labels = (np.exp(GB_model.predict(test_features)) + np.exp(ENST_model.predict(test_features_st)) + np.exp(lasso.predict(test_features_st)) + np.exp(KRR.predict(test_features_st)) ) / 4
