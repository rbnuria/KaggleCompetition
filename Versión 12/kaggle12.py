...
##### VERSIÓN 12:
## CAMBIOS -> ELIMINAMOS ALGUNAS VARIABLES Y NORMALIZAMOS MÁS VARIABLES
...
numeric_features = features.loc[:,['LotFrontage', 'LotArea', 'GrLivArea', 'TotalSF', 'MasVnrArea', 'LowQualFinSF', 'EnclosedPorch', 'X3SsnPorch', 'ScreenPorch', 'PoolArea', 'MiscVal']]
