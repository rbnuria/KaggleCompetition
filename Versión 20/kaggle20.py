...
#Y las que están muy relacionadas entre si -> CarGarage y CarArea muy correlacionadas -> quitamos CarGarage
#TotalBsmtSF y 1stFlorSF tambien -> quitamos 1stFlorSF
#features.drop(['GarageArea', 'X1stFlrSF'], axis = 1, inplace = True)
...
## Saving to CSV
#pd.DataFrame({'Id': test.Id, 'SalePrice': Final_labels}).to_csv('submission20.csv', index =False)