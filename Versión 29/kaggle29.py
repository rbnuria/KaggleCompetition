...
# **** quitamos algunas variables y cambiamos MSSubClass a categorica
#features['MSSubClass'] = features['MSSubClass'].astype('category')
#features = features.drop(['Street', 'Utilities', 'RoofMatl', 'Heating'], axis = 1)
...
## Saving to CSV
#pd.DataFrame({'Id': test.Id, 'SalePrice': Final_labels}).to_csv('submission27.csv', index =False)